...
- Paper clips: the desk's own currency. Closing any file pays 3 (+2 for a first solve, +2
  for an S, +1 cold, +2 daily, +3 for the weekly; a campaign file replayed more than three
...
- One head at a time: an ambient bubble (a purchase quip, a tab tip) waits while Lucien
  is giving a lesson instead of talking over it.
